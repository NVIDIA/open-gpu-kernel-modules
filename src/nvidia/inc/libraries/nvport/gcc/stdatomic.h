...
#ifndef __GCC_STDATOMIC_H
#define __GCC_STDATOMIC_H

/* If we're hosted, just use the system's stdatomic.h.  Otherwise use
 * a copy of gcc's stdatomic.h under the GCC Runtime Library Exception.
 */
#if __STDC_HOSTED__
