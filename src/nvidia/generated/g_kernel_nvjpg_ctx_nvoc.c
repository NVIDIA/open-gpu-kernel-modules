...
#ifdef DEBUG
char __nvoc_class_id_uniqueness_check__0x08c1ce = 1;
#endif
...
NV_STATUS __nvoc_ctor_NvjpgContext(NvjpgContext*, RmHalspecOwner *pRmhalspecowner, struct CALL_CONTEXT *arg_pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *arg_pParams);
...
NV_STATUS __nvoc_objCreate_NvjpgContext(NvjpgContext **ppThis, Dynamic *pParent, NvU32 createFlags, struct CALL_CONTEXT *arg_pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *arg_pParams)
{
    ...
    {
        pThis = portMemAllocNonPaged(sizeof(NvjpgContext));
    ...
    NV_CHECK_TRUE_OR_GOTO(status, LEVEL_ERROR, pParent != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_NvjpgContext_cleanup);
    ...
    NV_CHECK_TRUE_OR_GOTO(status, LEVEL_ERROR, pRmhalspecowner != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_NvjpgContext_cleanup);

    // Initialize vtable, RTTI, etc., then call constructor.
    __nvoc_init__NvjpgContext(pThis, pRmhalspecowner);
