...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_01(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_04(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_05(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_07(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_08(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_0B(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_0C(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
// No enabled chips use this variant provider
static void rpc_iGrp_ipVersions_Install_v2E_0D(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
#if 0
...
static NV_STATUS rpc_iGrp_ipVersions_Wrapup(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
    ...
    if (IsIPVersionInRange(pRpc, 0x290C0000, 0x2E00FFFF))
       pRpcHal->rpcCtrlExecPartitionsExport = rpcCtrlExecPartitionsExport_v29_0C;
    if (IsIPVersionInRange(pRpc, 0x2E010000, 0xFFFFFFFF))
       pRpcHal->rpcCtrlExecPartitionsExport = rpcCtrlExecPartitionsExport_v2E_01;
    if (IsIPVersionInRange(pRpc, 0x03000000, 0xFFFFFFFF))
    ...
    if (IsIPVersionInRange(pRpc, 0x2B130000, 0x2E0BFFFF))
       pRpcHal->rpcCtrlGpuGetInfoV2 = rpcCtrlGpuGetInfoV2_v2B_13;
    if (IsIPVersionInRange(pRpc, 0x2E0C0000, 0xFFFFFFFF))
       pRpcHal->rpcCtrlGpuGetInfoV2 = rpcCtrlGpuGetInfoV2_v2E_0C;
    ...
    if (IsIPVersionInRange(pRpc, 0x2E0B0000, 0xFFFFFFFF))
       pRpcHal->rpcCtrlGpuSetMigrationBlock = rpcCtrlGpuSetMigrationBlock_v2E_0B;
    if (IsIPVersionInRange(pRpc, 0x1A1F0000, 0xFFFFFFFF))
    ...
    if (IsIPVersionInRange(pRpc, 0x2B0E0000, 0x2E07FFFF))
       pRpcHal->rpcCtrlInternalMemsysSetZbcReferenced = rpcCtrlInternalMemsysSetZbcReferenced_v2B_0E;
    if (IsIPVersionInRange(pRpc, 0x2E080000, 0xFFFFFFFF))
       pRpcHal->rpcCtrlInternalMemsysSetZbcReferenced = rpcCtrlInternalMemsysSetZbcReferenced_v2E_08;
    ...
    if (IsIPVersionInRange(pRpc, 0x24050000, 0x2E00FFFF))
       pRpcHal->rpcCtrlExecPartitionsCreate = rpcCtrlExecPartitionsCreate_v24_05;
    if (IsIPVersionInRange(pRpc, 0x2E010000, 0xFFFFFFFF))
       pRpcHal->rpcCtrlExecPartitionsCreate = rpcCtrlExecPartitionsCreate_v2E_01;
    if (IsIPVersionInRange(pRpc, 0x1F0A0000, 0xFFFFFFFF))
...
#define _RPC_HAL_VERIFY_INTERFACE(_pHalFn) \
    ...
    _RPC_HAL_VERIFY_INTERFACE(pRpcHal->rpcCtrlGpuSetMigrationBlock);
...
static NV_STATUS rpc_iGrp_ipVersions_getInfo(IGRP_IP_VERSIONS_TABLE_INFO *pInfo)
{
    ...
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_01[] = {
        { 0x2E010000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_04[] = {
        { 0x2E040000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_05[] = {
        { 0x2E050000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_07[] = {
        { 0x2E070000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_08[] = {
        { 0x2E080000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_0B[] = {
        { 0x2E0B0000, 0xFFFFFFFF, },          // 
    };
    static const IGRP_IP_VERSION_RANGE  RPC_IGRP_IP_VERSIONS_RANGES_v2E_0C[] = {
...
#define _RPC_HAL_IGRP_ENTRY_INIT(v) \
    ...
    static const IGRP_IP_VERSIONS_ENTRY rpc_iGrp_ipVersions_table[] = {
        ...
        _RPC_HAL_IGRP_ENTRY_INIT(v2E_01),               // 
        _RPC_HAL_IGRP_ENTRY_INIT(v2E_04),               // 
        _RPC_HAL_IGRP_ENTRY_INIT(v2E_05),               // 
        _RPC_HAL_IGRP_ENTRY_INIT(v2E_07),               // 
        _RPC_HAL_IGRP_ENTRY_INIT(v2E_08),               // 
...
static void rpcHalIfacesSetup_TU102(RPC_HAL_IFACES *pRpcHal)
{
    ...
    static const RPC_HAL_IFACES rpcHalIfacesInitStruct_TU102 =
    {
        ...
        rpcCtrlGpuSetMigrationBlock_STUB,        // rpcCtrlGpuSetMigrationBlock
...
static void rpcHalIfacesSetup_GR100(RPC_HAL_IFACES *pRpcHal)
{

    // GR100's RPC hal interface function pointer block
    static const RPC_HAL_IFACES rpcHalIfacesInitStruct_GR100 =
    {
        rpcCtrlFifoSetupVfZombieSubctxPdb_STUB,   // rpcCtrlFifoSetupVfZombieSubctxPdb
        rpcVgpuPfRegRead32_STUB,                 // rpcVgpuPfRegRead32
        rpcCtrlBusUnsetP2pMapping_STUB,          // rpcCtrlBusUnsetP2pMapping
    ...
    };  // rpcHalIfacesInitStruct_GR100

    // init GR100's RPC function ptrs using the init struct above
    *pRpcHal = rpcHalIfacesInitStruct_GR100;
}
...
static void rpcHalIfacesSetup_GR102(RPC_HAL_IFACES *pRpcHal)
{
    rpcHalIfacesSetup_GR100(pRpcHal);   // GR102 interfaces identical to GR100
}
...
static void rpcHalIfacesSetup_T239D(RPC_HAL_IFACES *pRpcHal)
{
    rpcHalIfacesSetup_T234D(pRpcHal);   // T239D interfaces identical to T234D
}
