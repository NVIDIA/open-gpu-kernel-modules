...
#ifdef DEBUG
char __nvoc_class_id_uniqueness_check__097648 = 1;
#endif
...
void __nvoc_dtor_KernelGraphicsObject(Dynamic*);
...
#endif
    .objCreatefn =        &__nvoc_objCreateDynamic_KernelGraphicsObject,
...
static const struct NVOC_METADATA__KernelGraphicsObject __nvoc_metadata__KernelGraphicsObject = {
    ...
    .rtti.dtor      = &__nvoc_dtor_KernelGraphicsObject,
    .rtti.offset    = 0,
...
void __nvoc_dtor_KernelGraphicsObject(Dynamic* pThis) {

    KernelGraphicsObject *__nvoc_this = (KernelGraphicsObject *) pThis;

// Call destructor.
    __nvoc_kgrobjDestruct(__nvoc_this);
...
__nvoc_ctor_KernelGraphicsObject_fail__init:
    __nvoc_dtor_ChannelDescendant((Dynamic *)&pKernelGraphicsObject->__nvoc_base_ChannelDescendant);
...
NV_STATUS __nvoc_objCreateDynamic_KernelGraphicsObject(Dynamic **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    struct CALL_CONTEXT *pCallContext = va_arg(__nvoc_args, struct CALL_CONTEXT *);
    struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams = va_arg(__nvoc_args, struct RS_RES_ALLOC_PARAMS_INTERNAL *);

    return __nvoc_objCreate_KernelGraphicsObject((KernelGraphicsObject **) __nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags, pCallContext, pParams);
}
