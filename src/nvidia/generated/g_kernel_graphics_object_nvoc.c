...
void __nvoc_init_funcTable_KernelGraphicsObject(KernelGraphicsObject *pThis, RmHalspecOwner *pRmhalspecowner) {
    ...
    static const struct NVOC_VTABLE__KernelGraphicsObject vtable = {
        .__kgrobjGetMemInterMapParams__ = &kgrobjGetMemInterMapParams_IMPL,    // virtual override (rmres) base (chandes)
        ...
        .ChannelDescendant.GpuResource.RmResource.__rmresGetMemInterMapParams__ = &__nvoc_down_thunk_KernelGraphicsObject_rmresGetMemInterMapParams,    // virtual
        .__kgrobjGetSwMethods__ = &__nvoc_up_thunk_ChannelDescendant_kgrobjGetSwMethods,    // virtual inherited (chandes) base (chandes)
        .ChannelDescendant.__chandesGetSwMethods__ = &chandesGetSwMethods_IMPL,    // virtual
        .__kgrobjIsSwMethodStalling__ = &__nvoc_up_thunk_ChannelDescendant_kgrobjIsSwMethodStalling,    // virtual inherited (chandes) base (chandes)
        .ChannelDescendant.__chandesIsSwMethodStalling__ = &chandesIsSwMethodStalling_IMPL,    // virtual
        .__kgrobjCheckMemInterUnmap__ = &__nvoc_up_thunk_ChannelDescendant_kgrobjCheckMemInterUnmap,    // virtual inherited (chandes) base (chandes)
        ...
        .__kgrobjControl__ = &__nvoc_up_thunk_GpuResource_kgrobjControl,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjMap__ = &__nvoc_up_thunk_GpuResource_kgrobjMap,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjUnmap__ = &__nvoc_up_thunk_GpuResource_kgrobjUnmap,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjShareCallback__ = &__nvoc_up_thunk_GpuResource_kgrobjShareCallback,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjGetRegBaseOffsetAndSize__ = &__nvoc_up_thunk_GpuResource_kgrobjGetRegBaseOffsetAndSize,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjGetMapAddrSpace__ = &__nvoc_up_thunk_GpuResource_kgrobjGetMapAddrSpace,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjInternalControlForward__ = &__nvoc_up_thunk_GpuResource_kgrobjInternalControlForward,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjGetInternalObjectHandle__ = &__nvoc_up_thunk_GpuResource_kgrobjGetInternalObjectHandle,    // virtual inherited (gpures) base (chandes)
        ...
        .__kgrobjAccessCallback__ = &__nvoc_up_thunk_RmResource_kgrobjAccessCallback,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjGetMemoryMappingDescriptor__ = &__nvoc_up_thunk_RmResource_kgrobjGetMemoryMappingDescriptor,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjControlSerialization_Prologue__ = &__nvoc_up_thunk_RmResource_kgrobjControlSerialization_Prologue,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjControlSerialization_Epilogue__ = &__nvoc_up_thunk_RmResource_kgrobjControlSerialization_Epilogue,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjControl_Prologue__ = &__nvoc_up_thunk_RmResource_kgrobjControl_Prologue,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjControl_Epilogue__ = &__nvoc_up_thunk_RmResource_kgrobjControl_Epilogue,    // virtual inherited (rmres) base (chandes)
        ...
        .__kgrobjCanCopy__ = &__nvoc_up_thunk_RsResource_kgrobjCanCopy,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjIsDuplicate__ = &__nvoc_up_thunk_RsResource_kgrobjIsDuplicate,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjPreDestruct__ = &__nvoc_up_thunk_RsResource_kgrobjPreDestruct,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjControlFilter__ = &__nvoc_up_thunk_RsResource_kgrobjControlFilter,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjIsPartialUnmapSupported__ = &__nvoc_up_thunk_RsResource_kgrobjIsPartialUnmapSupported,    // inline virtual inherited (res) base (chandes) body
        ...
        .__kgrobjMapTo__ = &__nvoc_up_thunk_RsResource_kgrobjMapTo,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjUnmapFrom__ = &__nvoc_up_thunk_RsResource_kgrobjUnmapFrom,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjGetRefCount__ = &__nvoc_up_thunk_RsResource_kgrobjGetRefCount,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjAddAdditionalDependants__ = &__nvoc_up_thunk_RsResource_kgrobjAddAdditionalDependants,    // virtual inherited (res) base (chandes)
        ...
        .__kgrobjGetNotificationListPtr__ = &__nvoc_up_thunk_Notifier_kgrobjGetNotificationListPtr,    // virtual inherited (notify) base (chandes)
        ...
        .__kgrobjGetNotificationShare__ = &__nvoc_up_thunk_Notifier_kgrobjGetNotificationShare,    // virtual inherited (notify) base (chandes)
        ...
        .__kgrobjSetNotificationShare__ = &__nvoc_up_thunk_Notifier_kgrobjSetNotificationShare,    // virtual inherited (notify) base (chandes)
        ...
        .__kgrobjUnregisterEvent__ = &__nvoc_up_thunk_Notifier_kgrobjUnregisterEvent,    // virtual inherited (notify) base (chandes)
        ...
        .__kgrobjGetOrAllocNotifShare__ = &__nvoc_up_thunk_Notifier_kgrobjGetOrAllocNotifShare,    // virtual inherited (notify) base (chandes)
    ...
    pThis->__nvoc_vtable = &vtable;    // (kgrobj) this
