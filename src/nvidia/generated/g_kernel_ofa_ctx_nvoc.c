...
void __nvoc_init_funcTable_OfaContext(OfaContext *pThis, RmHalspecOwner *pRmhalspecowner) {
    ...
    static const struct NVOC_VTABLE__OfaContext vtable = {
        .__ofactxGetSwMethods__ = &__nvoc_up_thunk_ChannelDescendant_ofactxGetSwMethods,    // virtual inherited (chandes) base (chandes)
        .ChannelDescendant.__chandesGetSwMethods__ = &chandesGetSwMethods_IMPL,    // virtual
        .__ofactxIsSwMethodStalling__ = &__nvoc_up_thunk_ChannelDescendant_ofactxIsSwMethodStalling,    // virtual inherited (chandes) base (chandes)
        .ChannelDescendant.__chandesIsSwMethodStalling__ = &chandesIsSwMethodStalling_IMPL,    // virtual
        .__ofactxCheckMemInterUnmap__ = &__nvoc_up_thunk_ChannelDescendant_ofactxCheckMemInterUnmap,    // virtual inherited (chandes) base (chandes)
        ...
        .__ofactxControl__ = &__nvoc_up_thunk_GpuResource_ofactxControl,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxMap__ = &__nvoc_up_thunk_GpuResource_ofactxMap,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxUnmap__ = &__nvoc_up_thunk_GpuResource_ofactxUnmap,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxShareCallback__ = &__nvoc_up_thunk_GpuResource_ofactxShareCallback,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxGetRegBaseOffsetAndSize__ = &__nvoc_up_thunk_GpuResource_ofactxGetRegBaseOffsetAndSize,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxGetMapAddrSpace__ = &__nvoc_up_thunk_GpuResource_ofactxGetMapAddrSpace,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxInternalControlForward__ = &__nvoc_up_thunk_GpuResource_ofactxInternalControlForward,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxGetInternalObjectHandle__ = &__nvoc_up_thunk_GpuResource_ofactxGetInternalObjectHandle,    // virtual inherited (gpures) base (chandes)
        ...
        .__ofactxAccessCallback__ = &__nvoc_up_thunk_RmResource_ofactxAccessCallback,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxGetMemInterMapParams__ = &__nvoc_up_thunk_RmResource_ofactxGetMemInterMapParams,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxGetMemoryMappingDescriptor__ = &__nvoc_up_thunk_RmResource_ofactxGetMemoryMappingDescriptor,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxControlSerialization_Prologue__ = &__nvoc_up_thunk_RmResource_ofactxControlSerialization_Prologue,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxControlSerialization_Epilogue__ = &__nvoc_up_thunk_RmResource_ofactxControlSerialization_Epilogue,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxControl_Prologue__ = &__nvoc_up_thunk_RmResource_ofactxControl_Prologue,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxControl_Epilogue__ = &__nvoc_up_thunk_RmResource_ofactxControl_Epilogue,    // virtual inherited (rmres) base (chandes)
        ...
        .__ofactxCanCopy__ = &__nvoc_up_thunk_RsResource_ofactxCanCopy,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxIsDuplicate__ = &__nvoc_up_thunk_RsResource_ofactxIsDuplicate,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxPreDestruct__ = &__nvoc_up_thunk_RsResource_ofactxPreDestruct,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxControlFilter__ = &__nvoc_up_thunk_RsResource_ofactxControlFilter,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxIsPartialUnmapSupported__ = &__nvoc_up_thunk_RsResource_ofactxIsPartialUnmapSupported,    // inline virtual inherited (res) base (chandes) body
        ...
        .__ofactxMapTo__ = &__nvoc_up_thunk_RsResource_ofactxMapTo,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxUnmapFrom__ = &__nvoc_up_thunk_RsResource_ofactxUnmapFrom,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxGetRefCount__ = &__nvoc_up_thunk_RsResource_ofactxGetRefCount,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxAddAdditionalDependants__ = &__nvoc_up_thunk_RsResource_ofactxAddAdditionalDependants,    // virtual inherited (res) base (chandes)
        ...
        .__ofactxGetNotificationListPtr__ = &__nvoc_up_thunk_Notifier_ofactxGetNotificationListPtr,    // virtual inherited (notify) base (chandes)
        ...
        .__ofactxGetNotificationShare__ = &__nvoc_up_thunk_Notifier_ofactxGetNotificationShare,    // virtual inherited (notify) base (chandes)
        ...
        .__ofactxSetNotificationShare__ = &__nvoc_up_thunk_Notifier_ofactxSetNotificationShare,    // virtual inherited (notify) base (chandes)
        ...
        .__ofactxUnregisterEvent__ = &__nvoc_up_thunk_Notifier_ofactxUnregisterEvent,    // virtual inherited (notify) base (chandes)
        ...
        .__ofactxGetOrAllocNotifShare__ = &__nvoc_up_thunk_Notifier_ofactxGetOrAllocNotifShare,    // virtual inherited (notify) base (chandes)
    ...
    pThis->__nvoc_vtable = &vtable;    // (ofactx) this
