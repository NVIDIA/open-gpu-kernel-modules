...
static NvBool __nvoc_thunk_RsResource_dispswIsPartialUnmapSupported(struct DispSwObject *pResource) {
...
static void __nvoc_init_funcTable_DispSwObject_1(DispSwObject *pThis, RmHalspecOwner *pRmhalspecowner) {
    ...
    pThis->__dispswIsPartialUnmapSupported__ = &__nvoc_thunk_RsResource_dispswIsPartialUnmapSupported;
