...
static NvBool __nvoc_thunk_RsResource_vidmemIsPartialUnmapSupported(struct VideoMemory *pResource) {
...
static void __nvoc_init_funcTable_VideoMemory_1(VideoMemory *pThis) {
    ...
    pThis->__vidmemIsPartialUnmapSupported__ = &__nvoc_thunk_RsResource_vidmemIsPartialUnmapSupported;
