...
void __nvoc_dtor_OBJPFM(Dynamic*);
...
#endif
    .objCreatefn =        &__nvoc_objCreateDynamic_OBJPFM,
...
void __nvoc_dtor_OBJPFM(Dynamic* pThis) {

    OBJPFM *__nvoc_this = (OBJPFM *) pThis;
...
__nvoc_ctor_OBJPFM_fail__init:
    __nvoc_dtor_Object((Dynamic *)&pPfm->__nvoc_base_Object);
...
NV_STATUS __nvoc_objCreateDynamic_OBJPFM(Dynamic **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {

    return __nvoc_objCreate_OBJPFM((OBJPFM **) __nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags);
}
