...
SRCS_CXX += ../common/displayport/src/dp_configcaps2x.cpp
SRCS_CXX += ../common/displayport/src/dp_connectorimpl.cpp
SRCS_CXX += ../common/displayport/src/dp_connectorimpl2x.cpp
...
SRCS_CXX += ../common/displayport/src/dp_mst_displayid2.cpp
...
SRCS_CXX += ../common/displayport/src/dp_sst_displayid2.cpp
...
SRCS += ../common/modeset/timing/nvt_ovt.c
...
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-core.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-fermi.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-hopper.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-init.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-kepler.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-pascal.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-surface.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-turing.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-vertex-arrays.c
SRCS += ../common/unix/nvidia-3d/src/nvidia-3d-volta.c
SRCS += ../common/unix/nvidia-push/src/nvidia-push-init.c
SRCS += ../common/unix/nvidia-push/src/nvidia-push.c
...
SRCS += src/nvkms-difr.c
SRCS += src/nvkms-displayless.c
...
SRCS += src/nvkms-evo4.c
SRCS += src/nvkms-flip.c
SRCS += src/nvkms-framelock.c
SRCS += src/nvkms-hal.c
SRCS += src/nvkms-hdmi.c
SRCS += src/nvkms-headsurface-3d.c
SRCS += src/nvkms-headsurface-config.c
SRCS += src/nvkms-headsurface-ioctl.c
SRCS += src/nvkms-headsurface-matrix.c
SRCS += src/nvkms-headsurface-swapgroup.c
SRCS += src/nvkms-headsurface.c
