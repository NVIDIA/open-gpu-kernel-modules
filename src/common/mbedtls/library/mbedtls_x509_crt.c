 ...
 *
 *  https://www.ietf.org/rfc/rfc5280.txt (Certificates and CRLs)
 *  https://www.ietf.org/rfc/rfc3279.txt (Alg IDs for CRLs)
 *  https://www.ietf.org/rfc/rfc2986.txt (CSRs, aka PKCS#10)
 *
