...
static inline void _get_chip_id_for_alias_pgpu(NvU32 *dev_id, NvU32 *subdev_id)
{
    struct vgpu_alias_details {
        ...
        { 0x2BB5, 0x220B, 0x2BB5, 0x204E },
        { 0x2BB9, 0x2092, 0x2BB9, 0x2091 },
    };
...
static const struct {
    ...
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2271}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-3B
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2272}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-4Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2273}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-6Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2274}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-9Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2275}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-12Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2276}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-18Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _MINI_HALF)   , 2277}, // NVIDIA RTX PRO 5000 72GB Blackwell-1-36Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _FULL)                 , 2278}, // NVIDIA RTX PRO 5000 72GB Blackwell-2-18Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _FULL)                 , 2279}, // NVIDIA RTX PRO 5000 72GB Blackwell-2-24Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _FULL)                 , 2280}, // NVIDIA RTX PRO 5000 72GB Blackwell-2-36Q
    {0x2BB310DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _FULL)                 , 2281}, // NVIDIA RTX PRO 5000 72GB Blackwell-2-72Q
    ...
    {0x2BB510DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_QUARTER_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _QUARTER)       , 2310}, // NVIDIA RTX PRO 6000 Blackwell DC-1-5060E
    {0x2BB510DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _HALF)             , 2311}, // NVIDIA RTX PRO 6000 Blackwell DC-2-5070E
    {0x2BB510DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_HALF_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _HALF)             , 2312}, // NVIDIA RTX PRO 6000 Blackwell DC-2-5080E
    {0x2BB510DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _GFX_SIZE, _FULL)                 , 2313}, // NVIDIA RTX PRO 6000 Blackwell DC-4-96E
    ...
    {0x318210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_QUARTER_GPU                                                                      , 2261}, // NVIDIA B300X-2-67C
    {0x318210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU                                                                    , 2262}, // NVIDIA B300X-3-135C
    {0x318210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_HALF_GPU                                                                         , 2263}, // NVIDIA B300X-4-135C
    {0x318210DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU                                                                             , 2264}, // NVIDIA B300X-7-269C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_EIGHTHED_GPU | DRF_DEF(2080, _CTRL_GPU_PARTITION_FLAG, _REQ_DEC_JPG_OFA, _ENABLE), 2302}, // NVIDIA GB300X-1-35CME
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_EIGHTHED_GPU                                                                     , 2301}, // NVIDIA GB300X-1-35C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_QUARTER_GPU                                                                 , 2303}, // NVIDIA GB300X-1-70C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_QUARTER_GPU                                                                      , 2304}, // NVIDIA GB300X-2-70C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_MINI_HALF_GPU                                                                    , 2305}, // NVIDIA GB300X-3-139C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_ONE_HALF_GPU                                                                         , 2306}, // NVIDIA GB300X-4-139C
    {0x31C210DE, NV2080_CTRL_GPU_PARTITION_FLAG_FULL_GPU                                                                             , 2307}, // NVIDIA GB300X-7-278C
