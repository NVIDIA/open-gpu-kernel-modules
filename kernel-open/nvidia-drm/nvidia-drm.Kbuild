...
NV_CONFTEST_FUNCTION_COMPILE_TESTS += drm_bomb_has_gem_prime_res_obj
...
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_has_device_list
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_has_legacy_dev_list
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_has_set_busid
...
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_unload_has_int_return_type
...
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_prime_flag_present
...
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_master_set_has_int_return_type
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_has_gem_free_object
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_prime_pages_to_sg_has_drm_device_arg
NV_CONFTEST_TYPE_COMPILE_TESTS += drm_bomb_has_gem_prime_callbacks
