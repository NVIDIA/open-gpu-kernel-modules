...
NV_CONFTEST_FUNCTION_COMPILE_TESTS += add_memory_bomb_managed
...
NV_CONFTEST_TYPE_COMPILE_TESTS += device_bomb_of_match_table
...
NV_CONFTEST_TYPE_COMPILE_TESTS += add_memory_bomb_managed_has_mhp_flags_arg
